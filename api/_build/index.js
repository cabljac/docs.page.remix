...
var tailwind_default = "/build/_assets/tailwind-YFFXLCPY.css";
...
// app/styles/remove-backticks.css
var remove_backticks_default = "/build/_assets/remove-backticks-22ZWKVTB.css";
  ...
  (0, import_react11.useEffect)(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      for (let entry2 of entries) {
        if (entry2.isIntersecting && entry2.intersectionRatio === 1) {
...
var links2 = () => {
  return [
    ...
    { rel: "stylesheet", href: remove_backticks_default }
  ];
};
var meta = (props) => {
  var _a, _b;
